...
import Author from "~/components2/common/author";
import Advert from "~/components2/common/advert";
import Comment from '~/components2/comment'
import MarkdownNav from "~/components2/common/markdown-nav";

import DetailArticle from "~/components2/detail/detail-article";
import DetailMarkdown from "~/components2/detail/detail-markdown";
import DetailLabels from "~/components2/detail/detail-labels";
import DetailRecommend from '~/components2/detail/detail-recommend'

import { DetailWrapper } from '~/components2/detail/style'
